...
const STEPS = [
  ...
  },
  {
    ...
    desc: "OrbiSave automatically creates a dedicated Trust Account at a licensed partner bank. Your group's funds are ring-fenced in regulated custody, so they never touch OrbiSave's own accounts.",
