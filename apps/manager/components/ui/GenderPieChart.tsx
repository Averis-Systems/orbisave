...
/**
 * Gender breakdown of signed-up members in this country. Slices with zero
 * count are dropped. Stacked vertically so the card never spills in the
 * narrow side column of the overview grid.
 */
