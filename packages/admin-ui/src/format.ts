/**
 * Formatting helpers shared by both admin portals.
 *
 ...
 * them is a meaningless number. Admin surfaces therefore only ever render
 * money alongside the country it belongs to.
 */
